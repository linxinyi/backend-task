   ...
   */
    ...
    Searcher = function (prefs) {
        ...
        this.search = function (prefs) {
            ...
            var data = {};
            data.count = this.prefs.count;
            data.radius = this.prefs.radius;
            data.position = this.prefs.position;
            data.tags = this.prefs.tags;
